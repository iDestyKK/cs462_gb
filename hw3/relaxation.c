...
extern const struct relaxation_function_class_s _relaxation_openmp;

const struct relaxation_function_class_s * const _relaxation_classes[] =
    {&_relaxation_jacobi, &_relaxation_template, &_relaxation_template, &_relaxation_template, &_relaxation_openmp, NULL};
